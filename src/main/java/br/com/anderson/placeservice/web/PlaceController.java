package br.com.anderson.placeservice.web;
...
import br.com.anderson.placeservice.api.PlaceResponse;
import br.com.anderson.placeservice.domain.PlaceMapper;
import br.com.anderson.placeservice.domain.PlaceService;
...
public class PlaceController {
	...
	public ResponseEntity<Mono<Void>> delete(@PathVariable("id") Long id) {
		placeService.delete(id).subscribe();
