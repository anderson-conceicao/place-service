package br.com.anderson.placeservice;
...
import br.com.anderson.placeservice.api.PlaceRequest;
import br.com.anderson.placeservice.domain.Place;
import br.com.anderson.placeservice.domain.PlaceRepository;
...
public class PlaceServiceTests {
  ...
  public static final Place CENTRAL_PARK2 = new Place(
	      2L, "Central Park", "central-park", "NY", "NY", null, null);
  ...
  public void testDeleteSuccess() { 
      ...
      webTestClient
          .delete()
          .uri("/places/{id}", CENTRAL_PARK2.id())
          .exchange()
